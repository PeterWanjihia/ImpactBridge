...
<template>
  <section class="bg-ink text-white py-section-sm px-6 overflow-hidden relative">
    <div class="max-w-container mx-auto relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div class="lg:col-span-5 flex items-center gap-6">
          ...
          <div class="shrink-0 opacity-40 hidden sm:block">
            <svg class="w-24 h-24 text-cobalt-400 stroke-current fill-none" viewBox="0 0 100 100" stroke-width="1.5">
          ...
          <div class="space-y-2">
            <h2 class="text-3xl lg:text-4xl font-display font-semibold leading-tight text-white">
              Help create the next story of change.
            </h2>
            <p class="text-xs sm:text-sm text-cobalt-100/80 leading-relaxed font-sans max-w-sm">
        ...
        <div class="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-8 items-start relative">
          ...
          <div class="flex items-start gap-4">
            <div class="w-14 h-14 rounded-full bg-white flex items-center justify-center shrink-0 shadow-elevation-1">
              <Users class="w-6 h-6 text-ink" />
            </div>
            <div class="space-y-1.5">
              <h3 class="text-base font-semibold text-white">Fund a classroom</h3>
              <p class="text-xs text-cobalt-100/75 leading-relaxed">
                Give today and help more learners access meaningful learning.
              </p>
              <NuxtLink 
                to="/donate" 
                class="inline-flex items-center gap-2 text-xs font-bold text-white hover:text-cobalt-200 transition-colors pt-1"
              >
          ...
          <div class="flex items-start gap-4 md:pl-4">
            <div class="w-14 h-14 rounded-full bg-white flex items-center justify-center shrink-0 shadow-elevation-1">
              <Landmark class="w-6 h-6 text-ink" />
            </div>
            <div class="space-y-1.5">
